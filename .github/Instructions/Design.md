...
- **Buttons:**
  - _Primary:_ Solid Indigo-600 with white text.
  - _AI Action:_ Gradient from Indigo-600 to Purple-500.
  - _Secondary:_ Ghost style with 1px border and subtle hover fill.
- **Inputs:**
